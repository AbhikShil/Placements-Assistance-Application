...
$sqlp = "SELECT * FROM pusers WHERE email = '$email'";
...
$message .= "http://abhikshil.host20.uk/Placements%20App/resetpasswordu.php?user_id=$user_id&key=$key";
...
//http://abhikshil.host20.uk/
$message = "Please click on this link to reset your password:\n\n";
$message .= "http://abhikshil.host20.uk/Placements%20App/resetpasswordp.php?user_id=$user_id&key=$key";
if(mail($email, 'Reset your password', $message, 'From:'.'abhikshil@gmail.com')){
