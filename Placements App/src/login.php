...
$sqlp = "SELECT * FROM pusers WHERE email='$email' AND password='$password' AND activation='activated'";
...
if($count !== 1 and $countp !== 1){
    echo '<div class="alert alert-danger">Wrong Username or Password '. $countp .'</div>';
}
else {
    if(($countp === 1) and $count !== 1){
