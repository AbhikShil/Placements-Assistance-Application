  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navitems">
      <ul class="nav navbar-nav">
        ...
        <li class="active"><a href="mainloginpagestu.php">Placements<span class="sr-only">(current)</span></a></li>
      </ul>
...
-->
                      <button id="allNotes" type="button" class="btn btn-primary btn-lg">All Updates</button>
                      <button id="exit" type="button" class="btn green btn-danger pull-right">Exit</button>
                  </div>
                  <h2>All Availabe Placements Updates:</h2>
