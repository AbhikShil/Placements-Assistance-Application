    ...
    <div class="container" id="container">
          ...
          <div class="row">
              <div class="col-md-offset-3 col-md-6">
                  <div class="buttons">
                      <button id="addNote" type="button" class="btn btn-info btn-lg" data-dismiss="modal" data-target="#forgotpasswordModal" data-toggle="modal">Add Placements</button>
                      ...
                      <button id="allNotes" type="button" class="btn btn-primary btn-lg">All Placements</button>
                      <button id="next" type="button" class="btn btn-success btn-lg">Candidates</button>
                  </div>
...
<!--                  Ajax call to a php file-->
            ...
            <div class="modal-dialog">
              ...
              <div class="modal-body">
                  ...
                  <div class="form-group">
                      <label for="forgotemail" class="sr-only">Company Name:</label>
                      <input class="form-control" type="text" name="forgotemail" id="forgotemail" placeholder="Company Name" maxlength="50">
                  </div>
              </div>
    ...
    <script src="myplacements.js"></script>
  </body>
</html>